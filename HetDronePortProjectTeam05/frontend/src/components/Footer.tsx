...
import { FiArrowUp, FiMail, FiGithub, FiLinkedin } from 'react-icons/fi';
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-slate-300 text-sm leading-relaxed mb-4 max-w-md">
                            Advanced drone operations calculator designed for calculating flight geography, 
                            contingency volumes, and ground risk buffers with precision and reliability.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-slate-300">
                            ...
                            <li className="flex items-start space-x-2">
                                <div className="w-1.5 h-1.5 bg-blue-400 rounded-full mt-2 flex-shrink-0"></div>
                                <span>Exportation and Importation of previous calculations</span>
                            </li>
                        </ul>
                    </div>
                </div>
