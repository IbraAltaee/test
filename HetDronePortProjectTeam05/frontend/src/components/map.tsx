...
import { polygonData } from "@/data/zones";
...
const MapWithSquare: React.FC<MapWithSquareProps> = ({ data, zone }) => {
  ...
  useEffect(() => {
    if (data && zone) {
      ...
      const polygonCoords = zone.path.map(
  ...
  const handleEmailClick = async () => {
    ...
    const [kmlFile, pdf] = await Promise.all([
      EmailService.generateKmlFile(polygonKmlData),
      EmailService.generatePDFFile(data),
    ]);
    toast.info("Sending email...");
    const success = await EmailService.sendEmail({
      to: email,
      subject: "Your KML File",
      body: "Hello,\n\nPlease find your KML file attached.\n\nBest regards,\nYour App Team",
      files: [kmlFile, pdf],
    });
    ...
    <>
      <div className="flex flex-col gap-4">
        ...
        >
          ...
          {/* Legend overlay showing areas in square kilometers */}
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 pt-10 ">
                ...
                <p className="text-sm text-blue-700 mb-3">
                  Email the data directly to your inbox
                </p>
                <div className="mb-4">
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                ...
                >
                  {hasSelectedOptions
                    ? `Download Selected (${Object.values(downloadOptions).filter(Boolean).length
                    })`
