...
const SelectedDroneDetails: React.FC<{ drone: Drone; onUpdate: any }> = ({
  ...
  const { token } = useAuth();
  const { droneManagement, common, notifications, t } = useTranslations();
      ...
      {editableDrone && (
        <>
          ...
          <section className="bg-white p-6 rounded-xl shadow-md">
            <h3 className="text-xl font-semibold mb-4">{droneManagement("general")}</h3>
