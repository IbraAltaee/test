...
export const useFormHashComparison = () => {
  ...
  const generateFormHash = useCallback(
    (formState: DroneOperationFormState): string => {
      const formData = {
        ...
        altitudeMeasurementErrorType:
          formState.altitudeMeasurementErrorType || "",
        ...
        lateralContingencyManoeuvre:
          formState.lateralContingencyManoeuvre || "",
        ...
        verticalContingencyManoeuvre:
          formState.verticalContingencyManoeuvre || "",
  ...
  const isFormChanged = useCallback(
    (currentFormState: DroneOperationFormState): boolean => {
