...
import { FaChevronDown, FaFileImport, FaUpload } from "react-icons/fa";
    ...
    return (
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-4">
        ...
        >
          ...
          <div className="flex items-center">
            <FaChevronDown
              className={`w-5 h-5 text-blue-700 transition-transform duration-200 ${isQuickSetupOpen ? "rotate-180" : ""
                }`}
            />
          </div>
        </button>
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                <button
                  ...
                  className={`flex items-center justify-center px-4 py-3 rounded-lg text-sm font-medium transition-all duration-200 ${configMode === "import"
                ...
                {availableDrones.length > 0 && (
                  <button
                    ...
                    disabled={isProcessing}
                    className={`flex items-center justify-center px-4 py-3 rounded-lg text-sm font-medium transition-all duration-200 ${configMode === "drone"
