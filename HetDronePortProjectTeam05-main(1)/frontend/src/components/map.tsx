  ...
  useEffect(() => {
    if (data && zone) {
      ...
      if (
        ...
        toast.warn(notifications("bufferZoneTooLarge"));
        setInsetPolygons([]);
      } else {
                ...
                <div className="mb-4">
                  ...
                  <div className="space-y-2">
                    <label className="flex items-center p-2 hover:bg-green-100 rounded">
                      ...
                      />
                      <span className="ml-3 mr-2 text-sm text-green-800 font-medium">
                        {mapTranslations("standardKml")}
                      </span>
                      <InfoIconComponent text={mapTranslations("kmlTooltips.standardKml")} />
                    </label>
                    <label className="flex items-center p-2 hover:bg-green-100 rounded">
                      <input
                        type="checkbox"
                      ...
                      <InfoIconComponent text={mapTranslations("kmlTooltips.kml3d")} />
                    </label>
                    <label className="flex items-center p-2 hover:bg-green-100 rounded">
                      <input
                        type="checkbox"
                      ...
                      <InfoIconComponent text={mapTranslations("kmlTooltips.flightGeographyKml")} />
                    </label>
                  </div>
                </div>
                <button
